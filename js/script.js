...
function showResult(){
    ...
    if (userScore > 8){
        let scoreTag = '<span>Felicitaciones! 🎉, Tienes <p>'+ userScore +'</p> Sobre <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag; 
    }
    else if(userScore > 5){ 
        let scoreTag = '<span>Muy bien 😎, Tienes <p>'+ userScore +'</p> Sobre <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{ 
        let scoreTag = '<span> Flojo 😐, Solo tienes <p>'+ userScore +'</p> Sobre <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
